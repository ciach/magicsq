                                ...
                                for word_of_forth_words in forth_words:
                                    ...
                                    if fifth_words:
                                        for word_of_fifth_words in fifth_words:
                                            try:
                                                sixth_words = find_next_word(
                                                    words_list,
                                                    first_word[5]
                                                    + word_of_second_words[5]
                                                    + word_of_third_words[5]
                                                    + word_of_forth_words[5]
                                                    + word_of_fifth_words[5]
                                                    + "*",
                                                )
                                            except IndexError:
                                                print(
                                                ...
                                                sys_exit()
                                            if sixth_words:
                                                for word_of_sixth_words in sixth_words:
                                                    write_line_to_file(
...
if __name__ == "__main__":
    lista = read_file_to_list("B6.txt")
    words_lists = make_magic_squares(lista, "B6_out.txt")
    print(words_lists)
